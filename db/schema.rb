...
ActiveRecord::Schema.define(version: 20200308014731) do
  ...
  create_table "reply_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["replied_post_id"], name: "index_reply_relationships_on_replied_post_id"
    t.index ["reply_post_id", "replied_post_id"], name: "index_reply_relationships_on_reply_post_id_and_replied_post_id", unique: true
    t.index ["reply_post_id"], name: "index_reply_relationships_on_reply_post_id"
  end
